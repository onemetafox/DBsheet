            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <h6><strong style="color: red"></strong>件該当しました</h6>
                    </div>
                </div>
                <div class="card-body">
                    <div class="advance-search mb-6 collapse">
                                ...
                                <div class="col-lg-7 col-md-12 col-sm-12 input-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 input-group">
                                        <div class="d-flex flex-grow-1 align-items-center rounded">
                                            <input type="hidden" name="customer" value="<?= isset($filter['customer']) && ($filter['customer'])=='on'?'true':'false'?>">
                                            <div class="text-muted">お得意様</div>
                                            <div class="mr-4 flex-shrink-0 text-center ml-10" style="width: 40px;" onclick="setCustomer()">
                                                <i id="customer"  class="icon-2x  flaticon-star <?= isset($filter['customer']) && ($filter['customer'])=='on'?'active':'text-dark-50'?> "></i>
                                            </div>
                                        </div>
                    ...
                    <!-- <h6>検索結果 <strong><?= $search_count?></strong> 件該当しました</h6> -->
